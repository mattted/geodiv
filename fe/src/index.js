...
document.querySelector('#by_org').addEventListener('click', () => map.mountData('none', 'org_per_county'))
document.querySelector('#by_obs').addEventListener('click', () => map.mountData('none', 'obs_per_county'))
